...
public class JavaStreamsApp01 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] names = {"Nickolay", "Anna", "John", "Stephan", "Elena", "Kevin", "Petr", "Andre", "Hans", "Josh", "Serena"};
        Arrays.stream(names)
        ...
        List<String> people = Arrays.asList("Nickolay", "Anna", "John", "Stephan", "Elena", "Kevin", "Petr", "Andre", "Hans", "Josh", "Serena");
        people.stream()
...
//        rows1.close();
        ...
        // 12. Stream rows from CSV file, store fields in
        System.out.println("12. Stream rows from CSV file, store fields in");
        ...
        IntSummaryStatistics summaryStatistics = IntStream.of(7, 2, 19, 88, 73, 4, 10)
                        .summaryStatistics();
        System.out.println("summury = " + summaryStatistics);
